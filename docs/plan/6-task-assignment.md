...
|     | **Tổng điểm chính**                   | **100** |           |
| 11  | Bonus: Biểu đồ Chart.js              | +2   | ✅ Đã làm  |
| 12  | Bonus: Ghi log hệ thống vào DB       | +2   | ✅ Đã làm  |
| 13  | Bonus: Thanh toán qua mã QR          | +2   | ✅ Đã làm  |
...
### Giai đoạn 3 — Nghiệp vụ mua hàng
- [x] Giỏ hàng (Session-based Cart)
- [x] Thanh toán (Checkout + Transaction)
- [x] Xử lý đơn hàng (Employee cập nhật trạng thái)
- [x] Hủy đơn hàng + hoàn trả tồn kho
- [x] Lịch sử đơn hàng của Customer

### Giai đoạn 4 — Tìm kiếm, Phân trang, Thống kê
- [x] Tìm kiếm cơ bản + nâng cao cho tất cả danh sách
- [x] Phân trang cho tất cả danh sách
- [x] Viết 5 câu truy vấn thống kê
- [x] Xây dựng trang Dashboard hiển thị 5 báo cáo

### Giai đoạn 5 — Hoàn thiện & Bonus
- [x] Biểu đồ Dashboard (Chart.js) (Bonus +2đ)
- [x] Ghi log hệ thống đa chiều (Bonus +2đ)
- [x] Thanh toán bằng mã QR (Bonus +2đ)
...
- [x] Database có tối thiểu 5 bảng, đạt chuẩn 3NF
- [ ] Có đầy đủ script SQL tạo bảng + dữ liệu mẫu
- [ ] Có sơ đồ ERD và Database Diagram
- [x] Dự án chạy được trên Tomcat (không lỗi khi khởi động)
- [x] Có ít nhất 3 vai trò đăng nhập được (admin, employee, customer)
- [x] Filter phân quyền hoạt động đúng (admin không truy cập /customer, ngược lại)
- [x] Tất cả 5 thực thể có CRUD đầy đủ
- [x] Tìm kiếm cơ bản + nâng cao hoạt động
- [x] Phân trang hiển thị đúng trên tất cả danh sách
- [ ] Validation bắt đúng lỗi: trống, sai định dạng, trùng dữ liệu
- [x] 5 báo cáo thống kê hiển thị dữ liệu chính xác
- [x] Không còn câu lệnh SQL nào cộng chuỗi trực tiếp (dùng PreparedStatement)
