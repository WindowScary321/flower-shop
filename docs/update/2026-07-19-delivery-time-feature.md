# Cập nhật tính năng Thời gian giao hàng (Delivery Time)

## Bối cảnh
Cửa hàng cần chủ động thiết lập thời gian giao hàng (Delivery Time) cho các đơn hàng để dễ dàng sắp xếp nhân sự và chuẩn bị hoa.
Khách hàng không tự chọn thời gian khi đặt hàng, mà chỉ nhận được thông báo thời gian giao từ phía cửa hàng.
...
3. **Giao diện quản lý (Admin / Employee)**:
