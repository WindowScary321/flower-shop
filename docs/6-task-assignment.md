...
- [ ] Thiết kế và tạo Database trên SQL Server
- [ ] Thiết lập dự án NetBeans, cấu hình Tomcat
- [ ] Viết DBContext.java + ConnectDB.properties
- [ ] Tạo toàn bộ lớp Model (Java Beans)
- [ ] Dựng layout giao diện chung (header, footer, CSS)
- [ ] Triển khai Login, Register, Logout + Session

### Giai đoạn 2 — CRUD cốt lõi (Tuần 2)
- [ ] CRUD Categories (DAO + Servlet + JSP)
- [ ] CRUD Flowers (DAO + Servlet + JSP)
- [ ] CRUD Accounts (DAO + Servlet + JSP)
- [ ] Triển khai Filter phân quyền (Authentication + Authorization)
- [ ] Áp dụng Validation cho toàn bộ form đã có
