                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <c:if test="${order.status == 'Chờ xử lý' || order.status == 'Đang giao'}">
                                    <form action="${pageContext.request.contextPath}/employee/manage-orders" method="POST" class="d-inline-flex flex-column gap-2">
                                        ...
                                        <div class="form-check text-start mb-1 mt-1">
                                            <input class="form-check-input" type="checkbox" name="paymentStatus" value="true" id="payEmp-${order.orderId}" ${order.paymentStatus ? 'checked' : ''}>
                                            <label class="form-check-label small text-muted" for="payEmp-${order.orderId}">Đã thanh toán</label>
                                        </div>
